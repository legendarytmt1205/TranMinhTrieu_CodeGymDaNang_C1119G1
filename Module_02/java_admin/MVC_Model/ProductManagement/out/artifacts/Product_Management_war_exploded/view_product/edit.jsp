...
<form method="post">
    <fieldset>
        ...
        <table>
            ...
            <tr>
                <td>Description: </td>
                <td><input type="text" name="description" id="description" value="${requestScope["product"].getProductDesc()}"></td>
            </tr>
            <tr>
                <td>Suppliers: </td>
                <td><input type="text" name="suppliers" id="suppliers" value="${requestScope["product"].getSupplier()}"></td>
            </tr>
            <tr>
                <td></td>
